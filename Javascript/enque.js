...
// or the end, of the queue, and only the element at the front of the queue is allowed to be removed.

// We could use an array to represent a queue, but just like stacks, we want to limit the amount
//  of control we have over our queues.
